...
ps7_init
ps7_post_config
targets -set -nocase -filter {name =~ "ARM*#0" && jtag_cable_name =~ "Xilinx PYNQ-Z1 003017A4D1DDA"} -index 0
rst -processor
targets -set -nocase -filter {name =~ "ARM*#0" && jtag_cable_name =~ "Xilinx PYNQ-Z1 003017A4D1DDA"} -index 0
dow C:/Users/Mitch/Documents/DCA/PYNQ_integration/PYNQ_integration.sdk/read_test/Debug/read_test.elf
