...
HD_PWD='C:/Users/Mitch/Documents/DCA/PYNQ_integration/PYNQ_integration.runs/design_1_axi_derivative_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_derivative_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_derivative_0_0.tcl
