...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "MAX_MEANS_EXP" -parent ${Page_0}
...
proc update_PARAM_VALUE.MAX_MEANS_EXP { PARAM_VALUE.MAX_MEANS_EXP } {
	# Procedure called to update MAX_MEANS_EXP when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.MAX_MEANS_EXP { PARAM_VALUE.MAX_MEANS_EXP } {
	# Procedure called to validate MAX_MEANS_EXP
	return true
}
...
proc update_MODELPARAM_VALUE.MAX_MEANS_EXP { MODELPARAM_VALUE.MAX_MEANS_EXP PARAM_VALUE.MAX_MEANS_EXP } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.MAX_MEANS_EXP}] ${MODELPARAM_VALUE.MAX_MEANS_EXP}
}
